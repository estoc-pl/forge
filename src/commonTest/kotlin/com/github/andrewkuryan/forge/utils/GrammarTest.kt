...
abstract class GrammarTest(val buildNSA: Grammar.() -> NSA<EmptyNode>) {
...
data class NSAAssertion(
    ...
    val transitions: Map<StateRef, List<Pair<Guard.Meaningful<EmptyNode>, StateRef>>>,
...
fun assertNSA(nsa: NSA<EmptyNode>, getAssertion: (StateProvider) -> NSAAssertion) {
