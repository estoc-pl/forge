...
private fun <N : SyntaxNode> NSA<N>.hCombine(
    transition1: MeaningfulTransition<N>,
    transition2: MeaningfulTransition<N>,
...
fun <N : SyntaxNode> NSA<N>.hCombine(transitions: List<MeaningfulTransition<N>>): List<MeaningfulTransition<N>> =
